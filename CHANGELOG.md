...
- **runtime:** 贯通安装计划确认与失败恢复状态 (#111) (9f1c0c4)
...
- **ui:** 安装对话框实时展示进度明细并按闭包标注组件行 (#102) (662fe6c)

### Bug Fixes

- **runtime:** 启动 ensure 保留已安装组件闭包并本地化 428 提示 (#103) (2d61b94)
...
- **toolbar:** 加速边缘工具栏收展并支持配置隐藏露出像素 (#84) (068b42b)

### Bug Fixes

- **toolbar:** 收敛悬浮工具栏自动隐藏状态机消除偶发展开后不收回 (#85) (aa70423)
...
- **runtime:** 接入可靠维护与组件修复 (#28) (4bbc848)

### Bug Fixes

- **runtime:** 开机自启改用启动文件夹快捷方式以降低杀软误报 (#30) (596666a)
- **ci:** 修复镜像标签同步并完善六仓治理 (#29) (fc37651)
