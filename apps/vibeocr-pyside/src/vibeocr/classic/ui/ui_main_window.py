...
#endif // QT_CONFIG(tooltip)
        self.btnReinstallPython.setText(QCoreApplication.translate("MainWindowWidget", u"\u91cd\u88c5 Python \u8fd0\u884c\u65f6", None))
#if QT_CONFIG(tooltip)
        self.btnReinstallDeps.setToolTip(QCoreApplication.translate("MainWindowWidget", u"\u4f7f\u7528 pip \u91cd\u65b0\u5b89\u88c5 paddle/torch/mineru \u7b49 OCR \u4f9d\u8d56\uff0c\u4e0d\u5220\u9664\u4efb\u4f55\u76ee\u5f55\u3002", None))
#endif // QT_CONFIG(tooltip)
        self.btnReinstallDeps.setText(QCoreApplication.translate("MainWindowWidget", u"\u91cd\u88c5 OCR \u4f9d\u8d56", None))
#if QT_CONFIG(tooltip)
