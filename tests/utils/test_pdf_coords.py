...
class TestBboxToPixelPageRectShapes:
    ...
    def test_tuple_page_rect(self):
        result = bbox_to_pixel((10, 20, 30, 40), (0, 0, 100, 200), 72, source="normalized")
...
class TestBboxToPixelNormalized:
    ...
    def test_normalized_basic_scaling(self):
        ...
        result = bbox_to_pixel((0, 0, 1000, 1000), (0, 0, 200, 400), 72, source="normalized")
        assert result == pytest.approx((0.0, 0.0, 200.0, 400.0))

    def test_normalized_with_render_dpi(self):
        # DPI=144 → scale=2.0
        result = bbox_to_pixel((500, 500, 500, 500), (0, 0, 100, 100), 144, source="normalized")
...
class TestBboxToPixelPdfRotation:
    ...
    def test_pdf_rotation_0_no_mediabox(self):
        ...
        result = bbox_to_pixel((10, 20, 30, 40), (0, 0, 100, 200), 72, source="pdf", rotation=0)
    ...
    def test_pdf_rotation_90_uses_swapped_dims(self):
        ...
        result = bbox_to_pixel((10, 20, 30, 40), (0, 0, 100, 200), 72, source="pdf", rotation=90)
    ...
    def test_pdf_rotation_180(self):
        ...
        result = bbox_to_pixel((10, 20, 30, 40), (0, 0, 100, 200), 72, source="pdf", rotation=180)
    ...
    def test_pdf_rotation_270(self):
        ...
        result = bbox_to_pixel((10, 20, 30, 40), (0, 0, 100, 200), 72, source="pdf", rotation=270)
